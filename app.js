    ...
    onSubmit() {
      ...
      axios.get(url1)
        .then(response => {
          ...
          this.feelsLike = 'Feels like: ' + response.data.main.feels_like + '°';
          this.minTemp = 'Min Temp: ' + response.data.main.temp_min + '°';
          this.maxTemp = 'Max Temp: ' + response.data.main.temp_max + '°';
